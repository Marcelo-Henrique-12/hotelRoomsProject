...
<template>
    <Head title="Visualizar Quarto" />

    <AuthenticatedLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight text-center">Visualizar Quarto</h2>
        </template>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-20 lg:p-20">
                        ...
                        <div class="flex flex-wrap -mx-3 mb-6">
                            <div class="w-full px-3 mb-6">
                                ...
                                <input v-model="form.description" disabled
                                    class=" bg-gray-200 appearance-none block w-full text-gray-700 border rounded border-gray-300 py-3 px-4 leading-tight focus:outline-none focus:bg-white"
                        ...
                        <div class="flex flex-wrap -mx-3 mb-6">
                            <div class="w-full px-3 mb-6">
                                ...
                                <select v-model="form.hotel_id" disabled
                                    class="bg-gray-200 appearance-none block w-full text-gray-700 border rounded border-gray-300 py-3 px-4 leading-tight focus:outline-none focus:bg-white"
                                    id="hotel" name="hotel">

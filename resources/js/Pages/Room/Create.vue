...
<template>
    <Head title="Cadastro de Quartos" />

    <AuthenticatedLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight text-center">Cadastro de Quartos</h2>
        </template>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-20 lg:p-20">
                    <form class="w-full" @submit.prevent="submit">
                        ...
                        <div class="flex items-center justify-around mt-6">
                            ...
                            <PrimaryButton class="py-4 px-6" type="submit">Cadastrar</PrimaryButton>
                        </div>
                    </form>
                </div>
            </div>
